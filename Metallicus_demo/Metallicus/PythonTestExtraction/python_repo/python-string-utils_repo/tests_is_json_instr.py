...
class IsJsonTestCase(TestCase):
    ...
    def test_non_string_objects_are_properly_handled(self):
        ...
        print([str({
            ...
            'a': 1,
        })).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json(None))
        print([str(None), 'string', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json([1, 2, 3]))
        print([str([1, 2, 3]), 'string', ('python_' + str(type([1, 2, 3])).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json(500))
        print([str(500), 'string', ('python_' + str(type(500)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json(True))
        print([str(True), 'string', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json(set([1, 2])))
        print([str(set([1, 2])), 'string', ('python_' + str(type(set([1, 2]))).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_empty_string_are_invalid(self):
        self.assertFalse(is_json(''))
        print([str(''), 'string', ('python_' + str(type('')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json(' '))
        print([str(' '), 'string', ('python_' + str(type(' ')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_json_object_can_be_empty(self):
        self.assertTrue(is_json('{}'))
        print([str('{}'), 'string', ('python_' + str(type('{}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_external_spaces_are_ignored(self):
        self.assertTrue(is_json('{"foo":"bar"}'))
        print([str('{"foo":"bar"}'), 'string', ('python_' + str(type('{"foo":"bar"}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json(' { "foo": "bar" } '))
        print([str(' { "foo": "bar" } '), 'string', ('python_' + str(type(' { "foo": "bar" } ')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('\n            {\n                "foo": "bar"\n            }\n        '))
        print([str('\n            {\n                "foo": "bar"\n            }\n        '), 'string', ('python_' + str(type('\n            {\n                "foo": "bar"\n            }\n        ')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_attributes_quotes_are_mandatory(self):
        self.assertFalse(is_json('{foo: 1}'))
        print([str('{foo: 1}'), 'string', ('python_' + str(type('{foo: 1}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_string_values_should_be_wrapped_by_double_quotes(self):
        ...
        print([str('{"foo": hello}'), 'string', ('python_' + str(type('{"foo": hello}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json('{"foo": \'hello\'}'))
        print([str('{"foo": \'hello\'}'), 'string', ('python_' + str(type('{"foo": \'hello\'}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"foo": "hello"}'))
        print([str('{"foo": "hello"}'), 'string', ('python_' + str(type('{"foo": "hello"}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_boolean_should_be_lowercase(self):
        self.assertFalse(is_json('{"bool": True}'))
        print([str('{"bool": True}'), 'string', ('python_' + str(type('{"bool": True}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json('{"bool": FALSE}'))
        print([str('{"bool": FALSE}'), 'string', ('python_' + str(type('{"bool": FALSE}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"bool": true}'))
        print([str('{"bool": true}'), 'string', ('python_' + str(type('{"bool": true}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertIsInstance(json.loads('{"bool": true}'), dict)
        self.assertTrue(is_json('{"bool": false}'))
        print([str('{"bool": false}'), 'string', ('python_' + str(type('{"bool": false}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertIsInstance(json.loads('{"bool": false}'), dict)

    def test_null_should_be_lowercase(self):
        self.assertFalse(is_json('{"null": NULL}'))
        print([str('{"null": NULL}'), 'string', ('python_' + str(type('{"null": NULL}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json('{"null": Null}'))
        print([str('{"null": Null}'), 'string', ('python_' + str(type('{"null": Null}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"null": null}'))
        print([str('{"null": null}'), 'string', ('python_' + str(type('{"null": null}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_int_number_can_be_any_length(self):
        ...
        print([str('{"number": 1}'), 'string', ('python_' + str(type('{"number": 1}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"number": 99}'))
        print([str('{"number": 99}'), 'string', ('python_' + str(type('{"number": 99}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"number": 1000}'))
        print([str('{"number": 1000}'), 'string', ('python_' + str(type('{"number": 1000}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"number": 1234567890}'))
        print([str('{"number": 1234567890}'), 'string', ('python_' + str(type('{"number": 1234567890}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_float_numbers_should_use_dot_as_separator(self):
        self.assertFalse(is_json('{"float": 4,5}'))
        print([str('{"float": 4,5}'), 'string', ('python_' + str(type('{"float": 4,5}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"float": 4.5}'))
        print([str('{"float": 4.5}'), 'string', ('python_' + str(type('{"float": 4.5}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_negative_numbers_should_be_start_with_minus(self):
        ...
        print([str('{"number": - 2}'), 'string', ('python_' + str(type('{"number": - 2}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_json('{"number": - 2.5}'))
        print([str('{"number": - 2.5}'), 'string', ('python_' + str(type('{"number": - 2.5}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"number": -2}'))
        print([str('{"number": -2}'), 'string', ('python_' + str(type('{"number": -2}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"number": -2.5}'))
        print([str('{"number": -2.5}'), 'string', ('python_' + str(type('{"number": -2.5}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_array_can_be_empty(self):
        self.assertTrue(is_json('{"array": []}'))
        print([str('{"array": []}'), 'string', ('python_' + str(type('{"array": []}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"array": [ ]}'))
        print([str('{"array": [ ]}'), 'string', ('python_' + str(type('{"array": [ ]}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_object_can_be_empty(self):
        self.assertTrue(is_json('{"obj": {}}'))
        print([str('{"obj": {}}'), 'string', ('python_' + str(type('{"obj": {}}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_json('{"obj": { }}'))
        print([str('{"obj": { }}'), 'string', ('python_' + str(type('{"obj": { }}')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_cannot_have_trailing_comma_in_array(self):
        self.assertFalse(is_json('{"numbers": [1,2,3,]}'))
        print([str('{"numbers": [1,2,3,]}'), 'string', ('python_' + str(type('{"numbers": [1,2,3,]}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_cannot_have_trailing_comma_in_object(self):
        ...
        print([str('{"numbers": {"a": 1, "b": 2,}}'), 'string', ('python_' + str(type('{"numbers": {"a": 1, "b": 2,}}')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_string_can_contain_escaped_quotes(self):
        ...
        print([str(s), 'string', ('python_' + str(type(s)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_complete_json_case(self):
        ...
        print([str(string), 'string', ('python_' + str(type(string)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
