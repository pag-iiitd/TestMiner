...
class IsIsogramTestCase(TestCase):
    ...
    def test_non_string_objects_return_false(self):
        ...
        print([str(['xx']), 'string', ('python_' + str(type(['xx'])).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        ...
        print([str(object()), 'string', ('python_' + str(type(object())).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_is_isogram_returns_expected_bool(self):
        ...
        print([str('hello'), 'string', ('python_' + str(type('hello')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_isogram('hello world, how are you?'))
        print([str('hello world, how are you?'), 'string', ('python_' + str(type('hello world, how are you?')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_isogram('dermatoglyphics'))
        print([str('dermatoglyphics'), 'string', ('python_' + str(type('dermatoglyphics')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_isogram('abcdefghilmnopqrs'))
        print([str('abcdefghilmnopqrs'), 'string', ('python_' + str(type('abcdefghilmnopqrs')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
