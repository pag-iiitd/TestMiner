...
class IsPalindromeTestCase(TestCase):
    ...
    def test_non_string_objects_return_false(self):
        ...
        print([str(1), 'string', ('python_' + str(type(1)).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome(['xx']))
        print([str(['xx']), 'string', ('python_' + str(type(['xx'])).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        ...
        })).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome(False))
        print([str(False), 'string', ('python_' + str(type(False)).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome((1, 2, 3)))
        print([str((1, 2, 3)), 'string', ('python_' + str(type((1, 2, 3))).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome(object()))
        print([str(object()), 'string', ('python_' + str(type(object())).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_empty_strings_are_not_palindromes(self):
        self.assertFalse(is_palindrome(''))
        print([str(''), 'string', ('python_' + str(type('')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome(' '))
        print([str(' '), 'string', ('python_' + str(type(' ')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome(' \n\t '))
        print([str(' \n\t '), 'string', ('python_' + str(type(' \n\t ')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_strict_checking(self):
        ...
        print([str('nope!'), 'string', ('python_' + str(type('nope!')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_palindrome('i topi non avevano nipoti'))
        print([str('i topi non avevano nipoti'), 'string', ('python_' + str(type('i topi non avevano nipoti')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_palindrome('otto'))
        print([str('otto'), 'string', ('python_' + str(type('otto')).split("'")[1])], ', ', [str(True), 'strict', ('python_' + str(type(True)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_no_strict_mode(self):
        self.assertFalse(is_palindrome('nope!', False))
        print([str('nope!'), 'string', ('python_' + str(type('nope!')).split("'")[1])], ', ', [str(False), 'strict', ('python_' + str(type(False)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_palindrome('i topi non avevano nipoti', False))
        print([str('i topi non avevano nipoti'), 'string', ('python_' + str(type('i topi non avevano nipoti')).split("'")[1])], ', ', [str(False), 'strict', ('python_' + str(type(False)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_palindrome('otto', False))
        print([str('otto'), 'string', ('python_' + str(type('otto')).split("'")[1])], ', ', [str(False), 'strict', ('python_' + str(type(False)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
