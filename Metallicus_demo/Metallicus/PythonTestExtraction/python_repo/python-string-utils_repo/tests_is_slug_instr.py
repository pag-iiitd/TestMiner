...
class IsSlugTestCase(TestCase):
    ...
    def test_non_string_objects_return_false(self):
        ...
        print([str(1), 'string', ('python_' + str(type(1)).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug(['xx']))
        print([str(['xx']), 'string', ('python_' + str(type(['xx'])).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        ...
        })).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug(False))
        print([str(False), 'string', ('python_' + str(type(False)).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug((1, 2, 3)))
        print([str((1, 2, 3)), 'string', ('python_' + str(type((1, 2, 3))).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug(object()))
        print([str(object()), 'string', ('python_' + str(type(object())).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_recognizes_slugs(self):
        self.assertTrue(is_slug('yep-i-am-a-slug'))
        print([str('yep-i-am-a-slug'), 'string', ('python_' + str(type('yep-i-am-a-slug')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_slug('yep-i-am-a-slug', '-'))
        print([str('yep-i-am-a-slug'), 'string', ('python_' + str(type('yep-i-am-a-slug')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_slug('yep.i.am.a.slug', '.'))
        print([str('yep.i.am.a.slug'), 'string', ('python_' + str(type('yep.i.am.a.slug')).split("'")[1])], ', ', [str('.'), 'sign', ('python_' + str(type('.')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_slug('yep_i_am_a_slug', '_'))
        print([str('yep_i_am_a_slug'), 'string', ('python_' + str(type('yep_i_am_a_slug')).split("'")[1])], ', ', [str('_'), 'sign', ('python_' + str(type('_')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_exclude_invalid_slugs(self):
        self.assertFalse(is_slug(' nope'))
        print([str(' nope'), 'string', ('python_' + str(type(' nope')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug('nope '))
        print([str('nope '), 'string', ('python_' + str(type('nope ')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug(' nope '))
        print([str(' nope '), 'string', ('python_' + str(type(' nope ')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        ...
        print([str('-no-no-no-'), 'string', ('python_' + str(type('-no-no-no-')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug('100%no-slug!'))
        print([str('100%no-slug!'), 'string', ('python_' + str(type('100%no-slug!')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_slug('NOT-AS-UPPERCASE'))
        print([str('NOT-AS-UPPERCASE'), 'string', ('python_' + str(type('NOT-AS-UPPERCASE')).split("'")[1])], ', ', [str('-'), 'sign', ('python_' + str(type('-')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
