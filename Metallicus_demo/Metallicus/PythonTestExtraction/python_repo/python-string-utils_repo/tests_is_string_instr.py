...
class IsStringTestCase(TestCase):
    ...
    def test_return_false_for_non_string_objects(self):
        ...
        print([str(None), 'obj', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_string(False))
        print([str(False), 'obj', ('python_' + str(type(False)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_string(0))
        print([str(0), 'obj', ('python_' + str(type(0)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_string([]))
        print([str([]), 'obj', ('python_' + str(type([])).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_string({
            'a': 1,
        }))
        print([str({
            'a': 1,
        }), 'obj', ('python_' + str(type({
            'a': 1,
    ...
    def test_return_true_for_string_objects(self):
        ...
        print([str(''), 'obj', ('python_' + str(type('')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_string('hello world'))
        print([str('hello world'), 'obj', ('python_' + str(type('hello world')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_string('[a-z]'))
        print([str('[a-z]'), 'obj', ('python_' + str(type('[a-z]')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
