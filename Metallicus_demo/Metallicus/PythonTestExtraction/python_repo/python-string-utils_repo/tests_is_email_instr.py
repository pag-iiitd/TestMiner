...
class IsEmailTestCase(TestCase):
    ...
    def test_should_return_false_for_non_string_objects(self):
        ...
        print([str(False), 'string', ('python_' + str(type(False)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email(0))
        print([str(0), 'string', ('python_' + str(type(0)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_domain_part_is_required(self):
        ...
        print([str('name@'), 'string', ('python_' + str(type('name@')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_name_part_is_required(self):
        self.assertFalse(is_email('@foo.com'))
        print([str('@foo.com'), 'string', ('python_' + str(type('@foo.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_at_sign_is_required(self):
        self.assertFalse(is_email('name.site.com'))
        print([str('name.site.com'), 'string', ('python_' + str(type('name.site.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_extension_is_required(self):
        self.assertFalse(is_email('name@site'))
        print([str('name@site'), 'string', ('python_' + str(type('name@site')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('name@site.'))
        print([str('name@site.'), 'string', ('python_' + str(type('name@site.')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_extension_should_be_letters_only_from_2_to_4_chars(self):
        self.assertFalse(is_email('me@foo.123'))
        print([str('me@foo.123'), 'string', ('python_' + str(type('me@foo.123')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('me@foo.c'))
        print([str('me@foo.c'), 'string', ('python_' + str(type('me@foo.c')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('me@foo.!!'))
        print([str('me@foo.!!'), 'string', ('python_' + str(type('me@foo.!!')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('me@foo.___'))
        print([str('me@foo.___'), 'string', ('python_' + str(type('me@foo.___')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('me@foo.toolongext'))
        print([str('me@foo.toolongext'), 'string', ('python_' + str(type('me@foo.toolongext')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_name_part_cannot_contain_bad_signs(self):
        self.assertFalse(is_email('#me#@foo.com'))
        print([str('#me#@foo.com'), 'string', ('python_' + str(type('#me#@foo.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('me!@foo.com'))
        print([str('me!@foo.com'), 'string', ('python_' + str(type('me!@foo.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('[][]@foo.com'))
        print([str('[][]@foo.com'), 'string', ('python_' + str(type('[][]@foo.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('john%@john5music.net'))
        print([str('john%@john5music.net'), 'string', ('python_' + str(type('john%@john5music.net')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_domain_part_cannot_contain_bad_signs(self):
        ...
        print([str('someone@[foo].com'), 'string', ('python_' + str(type('someone@[foo].com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_part_cannot_be_uppercase(self):
        self.assertFalse(is_email('someone@SOMESITE.COM'))
        print([str('someone@SOMESITE.COM'), 'string', ('python_' + str(type('someone@SOMESITE.COM')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_part_cannot_contain_dots_sequence(self):
        self.assertFalse(is_email('name@em..ail.net'))
        print([str('name@em..ail.net'), 'string', ('python_' + str(type('name@em..ail.net')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_email('name@email..net'))
        print([str('name@email..net'), 'string', ('python_' + str(type('name@email..net')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_cannot_be_single_char(self):
        self.assertFalse(is_email('name@d.com'))
        print([str('name@d.com'), 'string', ('python_' + str(type('name@d.com')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_should_accept_valid_emails(self):
        self.assertTrue(is_email('me@foo.com'))
        print([str('me@foo.com'), 'string', ('python_' + str(type('me@foo.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('name@gmail.com'))
        print([str('name@gmail.com'), 'string', ('python_' + str(type('name@gmail.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('name2@gmail.com'))
        print([str('name2@gmail.com'), 'string', ('python_' + str(type('name2@gmail.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('PeterParker@gmail.com'))
        print([str('PeterParker@gmail.com'), 'string', ('python_' + str(type('PeterParker@gmail.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('first_name.last_name@yahoo.it'))
        print([str('first_name.last_name@yahoo.it'), 'string', ('python_' + str(type('first_name.last_name@yahoo.it')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('foo@domamin.subdomain.com'))
        print([str('foo@domamin.subdomain.com'), 'string', ('python_' + str(type('foo@domamin.subdomain.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('is1email@domain.org'))
        print([str('is1email@domain.org'), 'string', ('python_' + str(type('is1email@domain.org')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_email('UPPER_CASE_EMAIL@somesite.com'))
        print([str('UPPER_CASE_EMAIL@somesite.com'), 'string', ('python_' + str(type('UPPER_CASE_EMAIL@somesite.com')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
