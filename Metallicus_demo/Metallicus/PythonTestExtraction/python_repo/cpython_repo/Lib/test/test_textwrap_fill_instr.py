...
class IndentTestCases(BaseTestCase):
    ...
    def test_fill(self):
        ...
        print([str(self.text), 'text', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(40), 'width', ('python_' + str(type(40)).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
    ...
    def test_subsequent_indent(self):
        ...
        print([str(self.text), 'text', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(40), 'width', ('python_' + str(type(40)).split("'")[1])], ', ', [str('  * '), 'initial_indent', ('python_' + str(type('  * ')).split("'")[1])], ', ', [str('    '), 'subsequent_indent', ('python_' + str(type('    ')).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
