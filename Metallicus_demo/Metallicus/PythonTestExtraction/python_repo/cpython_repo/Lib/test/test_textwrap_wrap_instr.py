...
class BaseTestCase(unittest.TestCase):
    ...
    def check(self, result, expect):
        ...
        print([str(expect), 'EXP_op', ('python_' + str(type(expect)).split("'")[1])], '], [', sep='', end='')

    def check_wrap(self, text, width, expect, **kwargs):
        result = wrap(text, width, **kwargs)
        print([str(text), 'text', ('python_' + str(type(text)).split("'")[1])], ', ', [str(width), 'width', ('python_' + str(type(width)).split("'")[1])], ', ', [str(kwargs), None, ('python_' + str(type(kwargs)).split("'")[1])], ', ', sep='', end='')
...
class WrapTestCase(BaseTestCase):
    ...
    def test_whitespace(self):
        ...
        print([str(45), 'arg', ('python_' + str(type(45)).split("'")[1])], ', ', [str(True), 'fix_sentence_endings', ('python_' + str(type(True)).split("'")[1])], ', ', sep='', end='')
        result = wrapper.wrap(text)
        print([str(text), 'text', ('python_' + str(type(text)).split("'")[1])], ', ', [str(70), 'width', ('python_' + str(type(70)).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
        result = wrapper.fill(text)
        print([str(text), 'text', ('python_' + str(type(text)).split("'")[1])], ', ', sep='', end='')
        self.check(result, '\n'.join(expect))
    ...
    def test_fix_sentence_endings(self):
        ...
        print([str(60), 'arg', ('python_' + str(type(60)).split("'")[1])], ', ', [str(True), 'fix_sentence_endings', ('python_' + str(type(True)).split("'")[1])], ', ', sep='', end='')
    ...
    def test_hyphenated(self):
        ...
        print([str('|'), 'arg', ('python_' + str(type('|')).split("'")[1])], ', ', sep='', end='')
...
class LongWordTestCase(BaseTestCase):
    ...
    def test_nobreak_long(self):
        ...
        print([str(self.text), 'text', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(70), 'width', ('python_' + str(type(70)).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
        result = wrap(self.text, width=30, break_long_words=0)
        print([str(self.text), 'text', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(30), 'width', ('python_' + str(type(30)).split("'")[1])], ', ', [str(0), 'break_long_words', ('python_' + str(type(0)).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
...
class IndentTestCases(BaseTestCase):
    ...
    def test_initial_indent(self):
        ...
        print([str(self.text), 'text', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(40), 'width', ('python_' + str(type(40)).split("'")[1])], ', ', [str('     '), 'initial_indent', ('python_' + str(type('     ')).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
        expect = '\n'.join(expect)
        print([str(expect), 'expect', ('python_' + str(type(expect)).split("'")[1])], ', ', sep='', end='')
        result = fill(self.text, 40, initial_indent='     ')
        print([str(self.text), 'arg', ('python_' + str(type(self.text)).split("'")[1])], ', ', [str(40), 'arg', ('python_' + str(type(40)).split("'")[1])], ', ', [str('     '), 'initial_indent', ('python_' + str(type('     ')).split("'")[1])], ', ', sep='', end='')
        self.check(result, expect)
