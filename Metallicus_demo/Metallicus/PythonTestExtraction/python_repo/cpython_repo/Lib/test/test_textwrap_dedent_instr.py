...
class DedentTestCase(unittest.TestCase):
    ...
    def assertUnchanged(self, text):
        ...
        print([str(dedent(text)), 'EXP_op', ('python_' + str(type(dedent(text))).split("'")[1])], '], [', sep='', end='')
    ...
    def test_dedent_preserve_internal_tabs(self):
        ...
        print([str(dedent(expect)), 'EXP_op', ('python_' + str(type(dedent(expect))).split("'")[1])], '], [', sep='', end='')
