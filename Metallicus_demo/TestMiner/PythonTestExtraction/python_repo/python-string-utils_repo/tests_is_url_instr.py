...
class IsUrlTestCase(TestCase):
    ...
    def test_should_return_false_for_non_string_objects(self):
        ...
        print([str(None), 'string', ('python_' + str(type(None)).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url(False))
        print([str(False), 'string', ('python_' + str(type(False)).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url(0))
        print([str(0), 'string', ('python_' + str(type(0)).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url([]))
        print([str([]), 'string', ('python_' + str(type([])).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url({
            'a': 1,
        }))
        print([str({
            'a': 1,
        }), 'string', ('python_' + str(type({
            'a': 1,
        })).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_string_cannot_contain_spaces(self):
        ...
        print([str(' http://www.google.com'), 'string', ('python_' + str(type(' http://www.google.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://www.google.com '))
        print([str('http://www.google.com '), 'string', ('python_' + str(type('http://www.google.com ')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://www.google.com/ ncr'))
        print([str('http://www.google.com/ ncr'), 'string', ('python_' + str(type('http://www.google.com/ ncr')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://www.goo gle.com'))
        print([str('http://www.goo gle.com'), 'string', ('python_' + str(type('http://www.goo gle.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_scheme_is_required(self):
        self.assertFalse(is_url('google.com'))
        print([str('google.com'), 'string', ('python_' + str(type('google.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_extension_is_required_for_named_urls(self):
        self.assertFalse(is_url('http://google'))
        print([str('http://google'), 'string', ('python_' + str(type('http://google')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://google.'))
        print([str('http://google.'), 'string', ('python_' + str(type('http://google.')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_domain_extension_should_be_between_2_and_6_letters(self):
        self.assertFalse(is_url('http://google.c'))
        print([str('http://google.c'), 'string', ('python_' + str(type('http://google.c')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://google.abcdefghi'))
        print([str('http://google.abcdefghi'), 'string', ('python_' + str(type('http://google.abcdefghi')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_should_accept_any_scheme_by_default(self):
        self.assertTrue(is_url('http://site.com'))
        print([str('http://site.com'), 'string', ('python_' + str(type('http://site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://www.site.com'))
        print([str('http://www.site.com'), 'string', ('python_' + str(type('http://www.site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('https://site.com'))
        print([str('https://site.com'), 'string', ('python_' + str(type('https://site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('https://www.site.com'))
        print([str('https://www.site.com'), 'string', ('python_' + str(type('https://www.site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('ftp://site.com'))
        print([str('ftp://site.com'), 'string', ('python_' + str(type('ftp://site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('git://site.com'))
        print([str('git://site.com'), 'string', ('python_' + str(type('git://site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_should_restrict_checking_on_provided_schemes(self):
        ...
        print([str('git://site.com'), 'string', ('python_' + str(type('git://site.com')).split("'")[1])], ', ', [str(['http', 'https']), 'allowed_schemes', ('python_' + str(type(['http', 'https'])).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_url_cannot_start_with_dot(self):
        self.assertFalse(is_url('http://.site.com'))
        print([str('http://.site.com'), 'string', ('python_' + str(type('http://.site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_contain_dash(self):
        self.assertTrue(is_url('http://some-site-name.com'))
        print([str('http://some-site-name.com'), 'string', ('python_' + str(type('http://some-site-name.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_url_cannot_start_with_slash(self):
        ...
        print([str('http:///www.site.com'), 'string', ('python_' + str(type('http:///www.site.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')

    def test_www_is_optional(self):
        self.assertTrue(is_url('http://www.daveoncode.com'))
        print([str('http://www.daveoncode.com'), 'string', ('python_' + str(type('http://www.daveoncode.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://daveoncode.com'))
        print([str('http://daveoncode.com'), 'string', ('python_' + str(type('http://daveoncode.com')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_localhost_is_an_accepted_url(self):
        self.assertTrue(is_url('http://localhost'))
        print([str('http://localhost'), 'string', ('python_' + str(type('http://localhost')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_should_accept_valid_ip_url(self):
        self.assertTrue(is_url('http://123.123.123.123'))
        print([str('http://123.123.123.123'), 'string', ('python_' + str(type('http://123.123.123.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://1.123.123.123'))
        print([str('http://1.123.123.123'), 'string', ('python_' + str(type('http://1.123.123.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://1.1.123.123'))
        print([str('http://1.1.123.123'), 'string', ('python_' + str(type('http://1.1.123.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://1.1.1.123'))
        print([str('http://1.1.1.123'), 'string', ('python_' + str(type('http://1.1.1.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://1.1.1.1'))
        print([str('http://1.1.1.1'), 'string', ('python_' + str(type('http://1.1.1.1')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://123.123.123.1'))
        print([str('http://123.123.123.1'), 'string', ('python_' + str(type('http://123.123.123.1')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://123.123.1.1'))
        print([str('http://123.123.1.1'), 'string', ('python_' + str(type('http://123.123.1.1')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://123.1.1.1'))
        print([str('http://123.1.1.1'), 'string', ('python_' + str(type('http://123.1.1.1')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_should_exclude_invalid_ip(self):
        self.assertFalse(is_url('http://1.2.3'))
        print([str('http://1.2.3'), 'string', ('python_' + str(type('http://1.2.3')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://1.2.3.'))
        print([str('http://1.2.3.'), 'string', ('python_' + str(type('http://1.2.3.')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://123.123.123.1234'))
        print([str('http://123.123.123.1234'), 'string', ('python_' + str(type('http://123.123.123.1234')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://.123.123.123.123'))
        print([str('http://.123.123.123.123'), 'string', ('python_' + str(type('http://.123.123.123.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://123.123.123.123.'))
        print([str('http://123.123.123.123.'), 'string', ('python_' + str(type('http://123.123.123.123.')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_url('http://123.123...123.123'))
        print([str('http://123.123...123.123'), 'string', ('python_' + str(type('http://123.123...123.123')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_url_can_have_port_number(self):
        ...
        print([str('http://localhost:8080'), 'string', ('python_' + str(type('http://localhost:8080')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_contain_sub_folders(self):
        self.assertTrue(is_url('http://www.site.com/one'))
        print([str('http://www.site.com/one'), 'string', ('python_' + str(type('http://www.site.com/one')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://www.site.com/one/'))
        print([str('http://www.site.com/one/'), 'string', ('python_' + str(type('http://www.site.com/one/')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://www.site.com/one/two'))
        print([str('http://www.site.com/one/two'), 'string', ('python_' + str(type('http://www.site.com/one/two')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://www.site.com/one/two/'))
        print([str('http://www.site.com/one/two/'), 'string', ('python_' + str(type('http://www.site.com/one/two/')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://www.site.com/one/two/three/four/five/six'))
        print([str('http://www.site.com/one/two/three/four/five/six'), 'string', ('python_' + str(type('http://www.site.com/one/two/three/four/five/six')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_have_user_and_password(self):
        self.assertTrue(is_url('postgres://myuser:mypassword@localhost:5432/mydb'))
        print([str('postgres://myuser:mypassword@localhost:5432/mydb'), 'string', ('python_' + str(type('postgres://myuser:mypassword@localhost:5432/mydb')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_contain_file_extension(self):
        self.assertTrue(is_url('http://site.com/foo/photo.jpg'))
        print([str('http://site.com/foo/photo.jpg'), 'string', ('python_' + str(type('http://site.com/foo/photo.jpg')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/index.html'))
        print([str('http://site.com/index.html'), 'string', ('python_' + str(type('http://site.com/index.html')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_file_can_contains_multiple_dots(self):
        self.assertTrue(is_url('http://site.com/foo/file.name.ext'))
        print([str('http://site.com/foo/file.name.ext'), 'string', ('python_' + str(type('http://site.com/foo/file.name.ext')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_contain_query_string(self):
        self.assertTrue(is_url('http://site.com/foo/?'))
        print([str('http://site.com/foo/?'), 'string', ('python_' + str(type('http://site.com/foo/?')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/foo/?foo'))
        print([str('http://site.com/foo/?foo'), 'string', ('python_' + str(type('http://site.com/foo/?foo')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/foo/?foo=bar'))
        print([str('http://site.com/foo/?foo=bar'), 'string', ('python_' + str(type('http://site.com/foo/?foo=bar')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/foo/?foo=bar&baz=1'))
        print([str('http://site.com/foo/?foo=bar&baz=1'), 'string', ('python_' + str(type('http://site.com/foo/?foo=bar&baz=1')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/foo/?foo=bar&baz=1&'))
        print([str('http://site.com/foo/?foo=bar&baz=1&'), 'string', ('python_' + str(type('http://site.com/foo/?foo=bar&baz=1&')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_url_can_have_hash_part(self):
        self.assertTrue(is_url('http://site.com/foo#anchor'))
        print([str('http://site.com/foo#anchor'), 'string', ('python_' + str(type('http://site.com/foo#anchor')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_url('http://site.com/foo#anchor2-with_several+signs++'))
        print([str('http://site.com/foo#anchor2-with_several+signs++'), 'string', ('python_' + str(type('http://site.com/foo#anchor2-with_several+signs++')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_a_full_url(self):
        self.assertTrue(is_url('https://www.site.com/a/b/c/banana/file.html?foo=1&bar=2#hello-world'))
        print([str('https://www.site.com/a/b/c/banana/file.html?foo=1&bar=2#hello-world'), 'string', ('python_' + str(type('https://www.site.com/a/b/c/banana/file.html?foo=1&bar=2#hello-world')).split("'")[1])], ', ', [str(None), 'allowed_schemes', ('python_' + str(type(None)).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
...
class IsCreditCardTestCase(TestCase):
    sample_cards = {
        'VISA': ['4929108461099666', '4485341431836919', '4929383875909178', '4024007178235312', '4929943872251997'],
        'MASTERCARD': ['5593685744413543', '5299068126557657', '5519706741220334', '5349375673926726', '5536077751185034'],
        'DISCOVER': ['6011738421556670', '6011902207467698', '6011066039342048', '6011084365330958', '6011417613048024'],
        'AMERICAN_EXPRESS': ['378255041294558', '344411347420469', '376197548847524', '348870102379192', '340073988128712'],
        'JCB': ['3528968052436214', '213140714369305', '180095242210070', '213122809097983', '213181044765010'],
        'DINERS_CLUB': ['30161673137117', '38476920787395', '38652978387607', '36802519893181', '30347192978103'],
    }
    ...
    def test_should_validate_only_specific_card_type_if_specified(self):
        for card_type in self.sample_cards:
            for card_number in self.sample_cards[card_type]:
                self.assertTrue(is_credit_card(card_number, card_type=card_type), ('Invalid card: %s (%s)' % (card_number, card_type)))
                other_cards = self.sample_cards.copy()
                del other_cards[card_type]
                for other_card in other_cards:
                    self.assertFalse(is_credit_card(card_number, card_type=other_card), ('Card %s should not be a valid %s' % (card_number, other_card)))
...
class StripHtmlTestCase(TestCase):
    ...
    def test_should_be_able_to_remove_multiple_tags(self):
        ...
        self.assertEqual('aaaa', re.sub('\\s', '', stripped))
        stripped2 = strip_html('\n            a <div>(on the first line)</div>\n            a <span>(on the second line)</span>\n            a <strong>(on the third line)</strong>\n            a <hr />\n        ', keep_tag_content=True)
        self.assertEqual('a(onthefirstline)a(onthesecondline)a(onthethirdline)a', re.sub('\\s', '', stripped2))
