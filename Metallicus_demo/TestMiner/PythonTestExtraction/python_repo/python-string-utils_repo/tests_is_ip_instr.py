...
class IsIpTestCase(TestCase):
    ...
    def test_return_false_for_non_string_objects(self):
        ...
        print([str(1), 'string', ('python_' + str(type(1)).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_recognize_ip_strings(self):
        ...
        print([str('127.0.0.1'), 'string', ('python_' + str(type('127.0.0.1')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_ip('0.0.0.0'))
        print([str('0.0.0.0'), 'string', ('python_' + str(type('0.0.0.0')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_ip('255.255.10.1'))
        print([str('255.255.10.1'), 'string', ('python_' + str(type('255.255.10.1')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')

    def test_ip_cannot_contain_spaces(self):
        self.assertFalse(is_ip(' 127.0.0.1 '))
        print([str(' 127.0.0.1 '), 'string', ('python_' + str(type(' 127.0.0.1 ')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_ip('0.0.0.0 '))
        print([str('0.0.0.0 '), 'string', ('python_' + str(type('0.0.0.0 ')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_ip(' 255.255.10.1'))
        print([str(' 255.255.10.1'), 'string', ('python_' + str(type(' 255.255.10.1')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_ip('255. 255.10.1'))
        print([str('255. 255.10.1'), 'string', ('python_' + str(type('255. 255.10.1')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
    ...
    def test_numbers_cannot_be_divided_by_other_signs(self):
        ...
        print([str('0_0_0_0'), 'string', ('python_' + str(type('0_0_0_0')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertFalse(is_ip('255,255,10,1'))
        print([str('255,255,10,1'), 'string', ('python_' + str(type('255,255,10,1')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
