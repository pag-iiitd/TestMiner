...
class IsPangramTestCase(TestCase):
    ...
    def test_is_pangram_returns_expected_bool(self):
        ...
        print([str('hello world'), 'string', ('python_' + str(type('hello world')).split("'")[1])], ', ', [str(False), 'EXP_op', ('python_' + str(type(False)).split("'")[1])], '], [', sep='', end='')
        self.assertTrue(is_pangram('The quick brown fox jumps over the lazy dog'))
        print([str('The quick brown fox jumps over the lazy dog'), 'string', ('python_' + str(type('The quick brown fox jumps over the lazy dog')).split("'")[1])], ', ', [str(True), 'EXP_op', ('python_' + str(type(True)).split("'")[1])], '], [', sep='', end='')
