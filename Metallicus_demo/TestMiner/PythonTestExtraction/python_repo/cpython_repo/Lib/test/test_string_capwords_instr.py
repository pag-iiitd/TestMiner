...
class ModuleTest(unittest.TestCase):
    ...
    def test_capwords(self):
        ...
        print([str('abc def ghi'), 's', ('python_' + str(type('abc def ghi')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def Ghi'), 'EXP_op', ('python_' + str(type('Abc Def Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('abc\tdef\nghi'), 'Abc Def Ghi')
        print([str('abc\tdef\nghi'), 's', ('python_' + str(type('abc\tdef\nghi')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def Ghi'), 'EXP_op', ('python_' + str(type('Abc Def Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('abc\t   def  \nghi'), 'Abc Def Ghi')
        print([str('abc\t   def  \nghi'), 's', ('python_' + str(type('abc\t   def  \nghi')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def Ghi'), 'EXP_op', ('python_' + str(type('Abc Def Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('ABC DEF GHI'), 'Abc Def Ghi')
        print([str('ABC DEF GHI'), 's', ('python_' + str(type('ABC DEF GHI')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def Ghi'), 'EXP_op', ('python_' + str(type('Abc Def Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('ABC-DEF-GHI', '-'), 'Abc-Def-Ghi')
        print([str('ABC-DEF-GHI'), 's', ('python_' + str(type('ABC-DEF-GHI')).split("'")[1])], ', ', [str('-'), 'sep', ('python_' + str(type('-')).split("'")[1])], ', ', [str('Abc-Def-Ghi'), 'EXP_op', ('python_' + str(type('Abc-Def-Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('ABC-def DEF-ghi GHI'), 'Abc-def Def-ghi Ghi')
        print([str('ABC-def DEF-ghi GHI'), 's', ('python_' + str(type('ABC-def DEF-ghi GHI')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc-def Def-ghi Ghi'), 'EXP_op', ('python_' + str(type('Abc-def Def-ghi Ghi')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('   aBc  DeF   '), 'Abc Def')
        print([str('   aBc  DeF   '), 's', ('python_' + str(type('   aBc  DeF   ')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def'), 'EXP_op', ('python_' + str(type('Abc Def')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('\taBc\tDeF\t'), 'Abc Def')
        print([str('\taBc\tDeF\t'), 's', ('python_' + str(type('\taBc\tDeF\t')).split("'")[1])], ', ', [str(None), 'sep', ('python_' + str(type(None)).split("'")[1])], ', ', [str('Abc Def'), 'EXP_op', ('python_' + str(type('Abc Def')).split("'")[1])], '], [', sep='', end='')
        self.assertEqual(string.capwords('\taBc\tDeF\t', '\t'), '\tAbc\tDef\t')
        print([str('\taBc\tDeF\t'), 's', ('python_' + str(type('\taBc\tDeF\t')).split("'")[1])], ', ', [str('\t'), 'sep', ('python_' + str(type('\t')).split("'")[1])], ', ', [str('\tAbc\tDef\t'), 'EXP_op', ('python_' + str(type('\tAbc\tDef\t')).split("'")[1])], '], [', sep='', end='')
...
class TestTemplate(unittest.TestCase):
    ...
    def test_unicode_values(self):
        s = Template('$who likes $what')
        d = dict(who='t\xffm', what='f\xfe\x0ced')
